...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/flask-graphql-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7763&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/flask-graphql-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `flask-graphql` can be installed with:

```
conda install flask-graphql
```

It is possible to list all of the versions of `flask-graphql` available on your platform with:
